...
| Can the reviewer approve their own submission? | **Yes, since 2026-08-20** (was blocked in the API 2026-08-16–2026-08-20) | The block deadlocked the real single-admin case it was written for: with one admin who is also the primary submitter, every one of their own submissions had no possible reviewer. Revisited per this row's own "revisit if the queue backs up" clause — reopen if the reviewer pool ever grows past one and self-dealing becomes a live risk again |
